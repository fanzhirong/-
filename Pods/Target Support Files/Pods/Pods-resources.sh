...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "MobShareSDK/Official-Sources/ShareSDK/Core/Resource.bundle"
  install_resource "MobShareSDK/Official-Sources/ShareSDK/Core/zh-Hans.lproj/ShareSDKLocalizable.strings"
