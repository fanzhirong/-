...
@interface ChirurgeryViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation ChirurgeryViewController
...
-(void)getNetData
{
    if (self.page == 0)
    {
        [NetWorking getDetailFirstDataWithPath:ChiruPath page:self.page back:^(NSArray *arr) {
...
-(void)setViews
{
    self.navigationItem.title = @"外科药方";
