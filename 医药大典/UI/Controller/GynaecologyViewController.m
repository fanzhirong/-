...
@interface GynaecologyViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation GynaecologyViewController
...
-(void)getNetData
{
    if (self.page == 0)
    {
        [NetWorking getDetailFirstDataWithPath:GynaecoPath page:self.page back:^(NSArray *arr) {
