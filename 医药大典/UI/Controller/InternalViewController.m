...
@interface InternalViewController ()<UITableViewDataSource,UITableViewDelegate>
...
-(void)getNetData
{
    if (self.page == 0)
    {
        [NetWorking getDetailFirstDataWithPath:InternalPath page:self.page back:^(NSArray *arr) {
...
-(void)setViews
{
    self.navigationItem.title = @"内科药方";
