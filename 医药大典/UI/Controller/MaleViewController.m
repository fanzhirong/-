...
@interface MaleViewController ()<UITableViewDataSource,UITableViewDelegate>
...
-(void)getNetData
{
    if (self.page == 0)
    {
        [NetWorking getDetailFirstDataWithPath:MalePath page:self.page back:^(NSArray *arr) {
...
-(void)setViews
{
    self.navigationItem.title = @"男科药方";
